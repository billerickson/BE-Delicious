...
function register_cpt() {
	$labels = [
		'name'               => __( 'Block Areas', 'be-delicious' ),
		'singular_name'      => __( 'Block Area', 'be-delicious' ),
		'add_new'            => __( 'Add New', 'be-delicious' ),
		'add_new_item'       => __( 'Add New Block Area', 'be-delicious' ),
		'edit_item'          => __( 'Edit Block Area', 'be-delicious' ),
		'new_item'           => __( 'New Block Area', 'be-delicious' ),
		'view_item'          => __( 'View Block Area', 'be-delicious' ),
		'search_items'       => __( 'Search Block Areas', 'be-delicious' ),
		'not_found'          => __( 'No Block Areas found', 'be-delicious' ),
		'not_found_in_trash' => __( 'No Block Areas found in Trash', 'be-delicious' ),
		'parent_item_colon'  => __( 'Parent Block Area:', 'be-delicious' ),
		'menu_name'          => __( 'Block Areas', 'be-delicious' ),
	];
