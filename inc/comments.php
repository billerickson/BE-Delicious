...
function comment_navigation( $location = '' ) {
	...
	$output .= '<h3 class="screen-reader-text">' . esc_html__( 'Comment navigation', 'be-delicious' ) . '</h3>';
	$output .= '<div class="nav-links">';
	$output .= '<div class="nav-previous">' . get_previous_comments_link( esc_html__( 'Older Comments', 'be-delicious' ) ) . '</div>';
	$output .= '<div class="nav-next">' . get_next_comments_link( esc_html__( 'Newer Comments', 'be-delicious' ) ) . '</div>';
	$output .= '</div>';
	$output .= '</nav>';
...
function comment_form_button_class( $args ) {
	...
	$args['title_reply'] = __( 'Leave a comment', 'be-delicious' );
